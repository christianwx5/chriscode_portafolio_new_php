...
<body class="home page-template-default page page-id-3063 wpb-js-composer js-comp-ver-6.0.3 vc_responsive">
    <nav class="navbar no-margin-bottom alt-font bg-white sidebar-nav " data-offset=-59 style="background: url(imagen/relieve.jpg);
    padding: 6px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 navbar-header margin-ten-bottom sm-no-margin">
                                ...
                                <span class="icon-bar"></span>
                                                                            ...
                                                                            <img alt="Brando Responsive &amp; Multipurpose OnePage WordPress Theme" src="imagen/logo2.png" class="retina-logo"  />
                                                                        </a>
                                            </div>
                    <div class="col-md-12 margin-fifteen-tb sm-no-margin navigation-menu-wrap">
                        ...
                        if (isset($_REQUEST['num_proy'])){
                            ...
                            echo '<li id="menu-item-3078" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3078"><a href="#about" class="section-link">Quien soy</a></li>
...
-->
                                ...
                                <div id="custom_html-2" class="widget_text custom-widget widget_custom_html"><div class="textwidget custom-html-widget"><div class="footer-social margin-fifteen-top xs-margin-ten-top col-md-12 no-padding-lr"><a target="_blank" class="directpage" href="https://www.facebook.com/" rel="noopener noreferrer"><i class="fab fa-facebook-f icon"></i></a><a target="_blank" class="directpage" href="https://twitter.com/" rel="noopener noreferrer"><i class="fab fa-twitter"></i></a>
<a target="_blank" class="directpage" href="https://plus.google.com/" rel="noopener noreferrer"><i class="fab fa-google-plus-g"></i></a><a target="_blank" class="directpage" href="https://www.linkedin.com/" rel="noopener noreferrer"><i class="fab fa-linkedin-in"></i></a></div></div></div>                            </div>
                                    </div>
                </div>
            </div>
        </nav>
...
<a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="container">
                <div class="row">
                                ...
                                <span class="text-small text-uppercase alt-font">© 2020 Brando is proudly powered by <a href="http://www.themezaa.com/" target="_blank">ThemeZaa.</a></span>
                            </div>
                                        </div>
            </div>
        </div>
